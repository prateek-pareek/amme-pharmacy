...
import icon from "../../assets/Png/PartyPopper.png"; // Adjust path if needed
import image from "../../assets/Png/Frame 436.png"; // Replace with the left image as shown in your design
