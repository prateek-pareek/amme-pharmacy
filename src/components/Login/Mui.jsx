...
// import icon from "../../assets/Png/Frame 401.png"; // Adjust path if needed
...
//   return (
//     <div className="flex flex-col md:flex-row h-[100vh] items-center justify-center gap-6 p-4 overflow-hidden">
