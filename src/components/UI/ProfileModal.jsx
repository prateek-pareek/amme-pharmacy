                ...
                <form className="space-y-4">
                    ...
                    <div className="flex space-x-4">
                        <div className="flex-1">
                            ...
                            <input
                                type="text"
                                className="w-full border border-gray-300 rounded-md px-3 py-0 h-9 focus:ring-blue-500 focus:border-blue-500"
                            />
                        </div>
                        <div className="flex-1">
                    ...
                    <div>
                        ...
                        <div className="flex items-center">
                            ...
                            <input
                                type="text"
                                className="flex-1 border-t border-b border-r border-gray-300 rounded-r-md px-3 py-0 h-9 focus:ring-blue-500 focus:border-blue-500"
                            />
                        </div>
                    </div>
                    {/* Pharmacy Name Input */}
                    ...
                    {/* Form Buttons */}
                    <div className="flex justify-end space-x-4" style={{ marginTop: '7vh', marginBottom: '0px' }}>
                        <button
                            type="button"
                            onClick={toggleModal}
